...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _CartPage = __webpack_require__(200);
	...
	var App = function (_Component) {
	  ...
	  _createClass(App, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(_CartPage2.default, null);
	    }
	  }]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _ItemsTable = __webpack_require__(201);

	var _ItemsTable2 = _interopRequireDefault(_ItemsTable);

	var _BagFooter = __webpack_require__(208);

	var _BagFooter2 = _interopRequireDefault(_BagFooter);
	  ...
	  _createClass(CartPage, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        'div',
	        { className: 'wrapper' },
	        _react2.default.createElement(_ItemsTable2.default, null),
	        _react2.default.createElement(_BagFooter2.default, null)
	      );
	    }
	  }, {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var ItemsTable = function (_Component) {
	  _inherits(ItemsTable, _Component);

	  function ItemsTable(props) {
	    _classCallCheck(this, ItemsTable);

	    var _this = _possibleConstructorReturn(this, (ItemsTable.__proto__ || Object.getPrototypeOf(ItemsTable)).call(this, props));

	    _this.state = {
	      showModal: false,
	      editItem: {}
	    };
	    _this.editProdDetails = _this.editProdDetails.bind(_this);
	  ...
	  _createClass(ItemsTable, [{
	    ...
	    key: 'editProdDetails',
	    value: function editProdDetails(item) {
	    ...
	    value: function render() {
	      ...
	      var rows = this.props.items.map(function (item, key) {
	        return _react2.default.createElement(_Row2.default, { item: item, editProdDetails: _this2.editProdDetails });
	      });
	      var itemsLength = this.props.items.length + ' ITEMS';
	      return _react2.default.createElement(
	        'div',
	        ...
	        this.state.showModal ? _react2.default.createElement(_Modal2.default, { item: this.state.editItem, closeModal: this.closeModal }) : ''
	      );
	    }
	  }, {
	    key: 'componentDidMount',
	...
	function matchDispatchToProps(dispatch) {
	  return (0, _redux.bindActionCreators)({ loadtItems: _index.loadtItems, updatePrice: _index.updatePrice }, dispatch);
	}

	exports.default = (0, _reactRedux.connect)(mapStateToProps, matchDispatchToProps)(ItemsTable);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.editBag = exports.loadtItems = undefined;

	var _cart = __webpack_require__(203);

	var loadtItems = exports.loadtItems = function loadtItems() {
	  return {
	    type: 'LOAD_ITEMS',
	    payload: _cart.items.productsInCart
	  };
	};

	var editBag = exports.editBag = function editBag(productId, state) {
	  debugger;

	  return {
	    type: 'EDIT_BAG',
	    payload: { productId: productId, state: state }
	  };
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _ProdDetails = __webpack_require__(205);

	var _ProdDetails2 = _interopRequireDefault(_ProdDetails);
	...
	var Price = function Price(_ref) {
	  ...
	  return _react2.default.createElement(
	    'div',
	    null,
	    item.p_originalprice !== parseInt(item.p_price / item.p_quantity) ? _react2.default.createElement(
	      'span',
	      ...
	      item.p_originalprice.toFixed(2)
	    ) : '',
	...
	var Row = function Row(props) {
	  var item = props.item;
	  var src = '../../images/T' + item.p_id + '.jpg';
	  return _react2.default.createElement(
	    'div',
	    { className: 'row' },
	    _react2.default.createElement(
	    ...
	    _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'section',
	          null,
	          _react2.default.createElement(_ProdDetails2.default, { item: item, editProdDetails: props.editProdDetails })
	        ),
	        _react2.default.createElement(
	          'section',
	          { className: 'row-right-section' },
	          _react2.default.createElement(
	            'div',
	            { className: 'size' },
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              'div',
	              null,
	              _react2.default.createElement('input', { 'data-id': item.p_id, value: item.p_quantity })
	            )
	          ),
	          _react2.default.createElement(
	            'div',
	            { className: 'price' },
	            _react2.default.createElement(Price, { item: item })
	          )
	        )
	      ),
	      '\xA0 \xA0',
	      _react2.default.createElement(
	        'div',
	        { className: 'prod-update' },
	        _react2.default.createElement(
	          'a',
	          { onClick: function onClick() {
	              props.editProdDetails(item);
	            } },
	          'EDIT'
	        ),
	        '\xA0\xA0| \xA0 \xA0',
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var ProdDetails = function ProdDetails(props) {
	  var item = props.item;
	  var stle = { 'display': 'none' };
	  return _react2.default.createElement(
	    'div',
	    ...
	    _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          null,
	          'Style #:',
	          item.p_style.toUpperCase()
	        ),
	        _react2.default.createElement(
	          'li',
	          null,
	          'Colour:',
	          item.p_selected_color.name.toUpperCase()
	        ),
	        _react2.default.createElement(
	          'li',
	          { style: stle, className: 'li-size' },
	          'Size:',
	          item.p_selected_size.code.toUpperCase()
	        ),
	        _react2.default.createElement(
	          'li',
	          { style: stle, className: 'li-qty' },
	          'QTY:',
	          _react2.default.createElement('input', { value: item.p_quantity, disabled: true })
	        )
	      )
	    )
	  );
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Modal = function (_Component) {
	  ...
	  function Modal(props) {
	    ...
	    _this.state = {
	      selectedSize: _this.props.item.p_selected_size,
	      selectedQty: _this.props.item.p_quantity,
	      selectedColor: _this.props.item.p_selected_color

	    };
	    _this.closeModal = _this.closeModal.bind(_this);
	    _this.setProperties = _this.setProperties.bind(_this);
	  ...
	  _createClass(Modal, [{
	    ...
	    value: function setColor(e) {
	      var clr = this.props.item.p_available_options.colors.filter(function (item, key) {
	    ...
	    key: 'setProperties',
	    value: function setProperties(e, type) {
	      if (type == 'SIZE') {
	        var sze = this.props.item.p_available_options.sizes.filter(function (item, key) {
	    ...
	    value: function getColors() {
	      ...
	      var itemAct = this.props.item;
	      var colors = itemAct.p_available_options.colors.map(function (color, key) {
	        var stle = {
	          'padding': '10px 10px',
	          'border': color.name == _this2.state.selectedColor.name ? 'solid 2px grey' : 'solid 2px white',
	          'backgroundColor': color.hexcode
	        };
	        return _react2.default.createElement('span', { style: stle, 'data-color': color.hexcode, onClick: _this2.setColor });
	      });
	      return colors;
	    }
	  }, {
	    ...
	    value: function edit() {
	      debugger;
	      var selectedSize = this.props.item.p_selected_size.code;
	      var selectedQty = this.props.item.p_quantity;
	      var selectedColor = this.props.item.p_selected_color.hexcode;
	      if (selectedSize != this.state.selectedSize.code || selectedQty != this.state.selectedQty || selectedColor != this.state.selectedColor.hexcode) {
	    ...
	    key: 'render',
	    value: function render() {
	      var src = '../../images/T' + this.props.item.p_id + '.jpg';
	      var item = this.props.item;
	      var Colors = this.getColors();

	      return _react2.default.createElement(
	        'div',
	        { className: 'edit-modal', onClick: this.closeModal },
	        _react2.default.createElement(
	          'div',
	          { className: 'wrapper' },
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              ...
	              _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                  'li',
	                  { className: 'size-qty' },
	                  _react2.default.createElement(_DropDown2.default, { type: 'SIZE', item: item, setProperties: this.setProperties, selectedSize: this.state.selectedSize }),
	                  _react2.default.createElement(_DropDown2.default, { type: 'QTY', item: item, setProperties: this.setProperties, selectedQty: this.state.selectedQty })
	                ),
	                _react2.default.createElement(
	                  'li',
	                  { className: 'editButton', onClick: this.edit },
	                  _react2.default.createElement(
	                    'a',
	                    null,
	                    'EDIT'
	...
	function matchDispatchToProps(dispatch) {
	  return (0, _redux.bindActionCreators)({ editBag: _index.editBag }, dispatch);
	}

	exports.default = (0, _reactRedux.connect)(mapStateToProps, matchDispatchToProps)(Modal);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var DropDown = function (_Component) {
	  ...
	  function DropDown(props) {
	    ...
	    _this.setProperties = _this.setProperties.bind(_this);
	    _this.getDropOpts = _this.getDropOpts.bind(_this);
	    return _this;
	  }

	  _createClass(DropDown, [{
	    key: 'setProperties',
	    value: function setProperties(e) {
	      this.props.setProperties(e, this.props.type);
	    }
	  }, {
	    key: 'getDropOpts',
	    value: function getDropOpts() {
	      var _this2 = this;

	      var list = [];
	      var item = this.props.item;
	      var text = this.props.type == 'SIZE' ? 'SIZE' : 'QTY:' + item.p_quantity;

	      list.push(_react2.default.createElement(
	        'option',
	        { value: '', disabled: true, selected: true, style: { 'display': 'none' } },
	        text,
	        _react2.default.createElement(
	          'span',
	          null,
	      ...
	      if (this.props.type == 'SIZE') {
	        ...
	        var tempList = sizes.map(function (size, key) {
	          var cls = _this2.props.selectedSize.code == size.code ? 'selected' : '';
	          return _react2.default.createElement(
	            'option',
	            { className: cls, value: size.code.toUpperCase() },
	            size.code.toUpperCase(),
	            item.p_selected_size.code == size.code ? _react2.default.createElement(
	              'span',
	              { className: 'tick' },
	              '\u2714'
	            ) : ''
	        ...
	        list = [].concat(_toConsumableArray(list), _toConsumableArray(tempList));
	      } else {
	        for (var i = 1; i <= 10; i++) {
	          var cls = this.props.selectedQty == i ? 'selected' : '';
	          list.push(_react2.default.createElement(
	            'option',
	            { className: cls, value: i },
	            i,
	            parseInt(item.p_quantity) == i ? _react2.default.createElement(
	              'span',
	              { className: 'tick' },
	              '\u2714'
	            ) : ''
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'select',
	          { className: this.props.type, onChange: this.setProperties },
	          options
	        )
	      );
	    }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _PromoDiscount = __webpack_require__(209);

	var _PromoDiscount2 = _interopRequireDefault(_PromoDiscount);
	...
	var BagFooter = function (_Component) {
	  _inherits(BagFooter, _Component);

	  function BagFooter() {
	    _classCallCheck(this, BagFooter);

	    return _possibleConstructorReturn(this, (BagFooter.__proto__ || Object.getPrototypeOf(BagFooter)).apply(this, arguments));
	  }

	  _createClass(BagFooter, [{
	    key: 'render',
	    value: function render() {
	      return _react2.default.createElement(
	        'div',
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'p',
	            null,
	            'Chat with one of our sttylists'
	          ),
	          _react2.default.createElement(
	            'p',
	            null,
	        ...
	        _react2.default.createElement(_PromoDiscount2.default, null)
	      );
	    }
	  }, {
	    key: 'componentDidMount',
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var PromoDiscount = function (_Component) {
	  _inherits(PromoDiscount, _Component);

	  function PromoDiscount() {
	    _classCallCheck(this, PromoDiscount);

	    return _possibleConstructorReturn(this, (PromoDiscount.__proto__ || Object.getPrototypeOf(PromoDiscount)).apply(this, arguments));
	  }

	  _createClass(PromoDiscount, [{
	    key: "render",
	    value: function render() {
	      return _react2.default.createElement(
	        "div",
	        { className: "promo-items-footer" },
	        _react2.default.createElement(
	          "ul",
	          { className: "total-price-details" },
	          _react2.default.createElement(
	            "li",
	            null,
	            _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            "li",
	            { className: "right" },
	            _react2.default.createElement("img", { src: "../../images/lock.jpg" }),
	          ...
	          _react2.default.createElement(
	            ...
	            "\xA0to have your cart and have access to your items on mobile,tablet and desktop."
	          )
	        )
	      );
	    }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _cartItemsReducer = __webpack_require__(211);

	var _cartItemsReducer2 = _interopRequireDefault(_cartItemsReducer);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var rootReducer = (0, _redux.combineReducers)({
	  items: _cartItemsReducer2.default
	});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var cartItemsReducer = function cartItemsReducer() {
	  ...
	  switch (action.type) {
	    ...
	    case 'EDIT_BAG':
	      var copy = Object.assign({}, _cart.items);
	      debugger;
	      return copy.productsInCart.map(function (item, key) {
	...
	exports.default = cartItemsReducer;
